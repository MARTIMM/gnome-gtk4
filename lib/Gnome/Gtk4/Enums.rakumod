...
unit class Gnome::Gtk4::Enums:auth<github:MARTIMM>:ver<0.1.0>;
...
flag inside a B<Gnome::Gtk4::Box>, then the widget might get extra space.  If
...
B<Gnome::Gtk4::BaselinePosition> to select where to put the baseline inside the
...
Used for justifying the text inside a B<Gnome::Gtk4::Label> widget. (See also
B<Gnome::Gtk4::Alignment>).
...
Represents the orientation of widgets and other objects which can be switched between horizontal and vertical orientation on the fly, like B<Gnome::Gtk4::Toolbar> or B<Gnome::Gtk4::GesturePan>.
...
Represents the packing location B<Gnome::Gtk4::Box> children. (See: B<Gnome::Gtk4::VBox>,
B<Gnome::Gtk4::HBox>, and B<Gnome::Gtk4::ButtonBox>).
...
tabs of a B<Gnome::Gtk4::Notebook>, the handle of a B<Gnome::Gtk4::HandleBox> or the label of a
B<Gnome::Gtk4::Scale>.
...
Indicated the relief to be drawn around a B<Gnome::Gtk4::Button>.
...
Used to change the appearance of an outline typically provided by a B<Gnome::Gtk4::Frame>.
...
the widget is drawn. The B<Gnome::Gtk4::StateType> enumeration is also used to
identify different colors in a B<Gnome::Gtk4::Style> for drawing, so states can be
used for subparts of a widget as well as entire widgets.

Deprecated: 3.14: All APIs that are using this enumeration have been deprecated
in favor of alternatives using B<Gnome::Gtk4::StateFlags>.
...
Used to customize the appearance of a B<Gnome::Gtk4::Toolbar>. Note that
...
Describes hints that might be taken into account by input methods or applications. Note that input methods may already tailor their behaviour according to the B<Gnome::Gtk4::InputPurpose> of the entry.
...
Describes the state of a B<Gnome::Gdk3::EventSequence> in a B<Gnome::Gtk4::Gesture>.
